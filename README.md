...
현재 진행 중인 내용 정리를 모두 마친 뒤에는, 기초 수준이지만 좀 더 구체적으로 알고리즘과 모델에 대하여 설명하는 **'파이썬 라이브러리를 활용한 머신러닝'** 이라는 서적의 내용을 정리하여 업로드 할 예정입니다. 내용 자체는 많지 않으므로 빠른 시일 내에 정리를 마칠 수 있으리라 기대합니다.
