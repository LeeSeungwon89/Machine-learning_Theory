...
현재는 머신러닝 분야의 기초를 다룬 **'혼자 공부하는 머신러닝 + 딥러닝'** 이라는 서적을 공부한 내용을 정리하여 업로드 하는 중입니다. 기초적인 내용을 최대한 쉽게 전달하려 노력한 서적이지만 처음 머신러닝을 공부하는 비전공자 학습자 입장에서는 이런 서적조차도 이해하기 다소 어려운 부분이 많다는 점을 느꼈습니다. 차근차근 공부하여 전부 이해한 후에 코드와 주석으로 써내려 가고 있습니다.
