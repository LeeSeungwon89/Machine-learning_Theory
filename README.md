...
현재는 머신러닝 분야의 기초를 다룬 **'혼자 공부하는 머신러닝 + 딥러닝'** 이라는 서적을 공부한 내용을 정리하여 업로드 하는 중입니다. 기초적인 내용을 최대한 쉽게 전달하려 노력한 서적이지만 처음 머신러닝을 공부하는 비전공자 학습자에게는 다소 어려울 수 있다는 점을 느꼈습니다. 차근차근 공부하여 이해한 후에 코드와 주석으로 써내려 갑니다.
