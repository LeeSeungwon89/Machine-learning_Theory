...
21.9.21 자로 이전에 정리했던 서적보다 높은 난도이면서 좀 더 구체적으로 알고리즘과 모델을 설명하는 **'파이썬 라이브러리를 활용한 머신러닝'** 이라는 서적을 정리하여 업로드를 마쳤습니다. 난도가 많이 오른 터라 예상보다 시간이 오래 걸렸습니다. 이번 서적을 정리하면서 스스로 이전보다 더욱 크게 성장하고 있다고 느꼈고, 지속적으로 떨쳐내기 어려웠던 막연한 두려움을 해소할 수 있었습니다. 무엇보다도 앞으로는 이전보다 더욱 빠르고 심층적으로 학습할 수 있겠다는 자신감을 얻었습니다.    
