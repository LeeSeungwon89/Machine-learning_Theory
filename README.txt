...
아울러 스스로 바라는 프로젝트의 궁극적인 목적은 두 가지입니다.

1. 추후 더 깊이 이어갈 머신러닝 학습을 목적으로 현재까지 배운 내용을 정리하여 지식 기반을 닦는다.
2. 머신러닝 공부를 시작한 어떤 newbie든 필자의 정리본을 보면 쉽게 이해할 수 있도록 머신러닝 개념을 최대한 쉽고 친절하게 전달하는 참고본을 만든다.
